...
- `CLAUDE.md` vs `AGENTS.md` - in this repo the root `AGENTS.md` is a symlink to `CLAUDE.md` (Codex reads `AGENTS.md`, Claude reads `CLAUDE.md`, both see the same file). Edit `CLAUDE.md`; do not replace the symlink with a divergent copy.
